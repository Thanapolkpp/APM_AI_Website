...
const ModeCard = ({ title, icon, description, buttonIcon, colors, onClick }) => {
    return (
        ...
        >
            <div className={`w-24 h-24 rounded-full flex items-center justify-center text-5xl mb-6 shadow-inner ${colors.iconBg}`}>
                {icon}
            </div>
            ...
            <div className="mt-auto w-full">
                <button className={`w-full py-4 rounded-xl font-bold shadow-sm transition-colors flex items-center justify-center gap-2 pointer-events-none ${colors.button}`}>
